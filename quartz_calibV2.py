...
for channel in channel_list:
    ...
    print(f'Channel {channel} positive voltage calibration complete')
time.sleep(1)

print('Switching to negative excitation voltage')
...
for channel in channel_list:
    ...
    print(f'Channel {channel} negative voltage calibration complete')

print('Voltages captured for all channels - calculating slope and offset')
...
for ch in range(0, len(channel_list)):
    ...
    if ch_pass != 'Pass':
        overall_pass = False
    print(f'Channel {ch+1} calbration result: {ch_pass}')
r_file.close()
